...
<head>
    ...
    <title>Kelola Tautan Produk Anda - Produk.PW</title>
</head>
<body class="container mx-auto">
    <?php include('navbar.php');?>
    <div class="bodyx container mx-auto p-5">
    <div class="hero min-h-screen bg-base-200">
  <div class="hero-content text-center">
    <div class="max-w-md">
      <h1 class="text-5xl font-bold">ProdukPW</h1>
      <p class="py-6">an simple powerfull link management & absolutely <i><strong>free</strong></i></p>
      <button class="btn btn-primary" onclick="location.href='#getUsername'">Get Username</button>
    </div>
  </div>
</div>
<div class="gallery mt-5 mb-5">
<div class="text-2xl text-center mb-5">Our Features</div>
  ...
  <div id="slide4" class="carousel-item relative w-full">
    ...
    <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      ...
      <a href="#slide1" class="btn btn-circle">❯</a>
        ...
        <div class="konten" id="getUsername">
        <div class="flex flex-col w-full lg:flex-row mt-4">
      <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center">
      <div class="form-control">
  <label class="label">
    <!-- <span class="label-text">Get Username</span> -->
  </label>
  <label class="input-group">
    <span>https://produk.pw/</span>
    ...
    <button class="btn btn-primary" onclick="register()();">Register</button>
      ...
      <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center">Signin</div>
    </div>
        </div>
...
let username = document.getElementById("username");
  ...
  let func = function() { alert(username); };
